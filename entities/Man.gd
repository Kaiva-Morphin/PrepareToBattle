...
func set_armor_head(e : HeadArmor):
	...
	if e:
		...
		attribute_container.override_armor_head_attributes(e.attributes)
...
func set_armor_chest(e : ChestArmor):
	...
	if e:
		...
		attribute_container.override_armor_chest_attributes(e.attributes)
...
func set_armor_legs(e : LegsArmor):
	...
	if e:
		...
		attribute_container.override_armor_legs_attributes(e.attributes)
